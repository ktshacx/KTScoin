...
const char* BIP71_MIMETYPE_PAYMENT = "application/garlicoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/garlicoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/garlicoin-paymentrequest";
