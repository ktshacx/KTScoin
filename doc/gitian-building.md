...
For example:
```bash
URL=https://github.com/thrasher-/garlicoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit garlicoin=${COMMIT} --url garlicoin=${URL} ../garlicoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit garlicoin=${COMMIT} --url garlicoin=${URL} ../garlicoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit garlicoin=${COMMIT} --url garlicoin=${URL} ../garlicoin/contrib/gitian-descriptors/gitian-osx.yml
```
